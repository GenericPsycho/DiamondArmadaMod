...
if (!variable_global_exists("saveroom"))
{
    ...
    global.throw_sprite[720] = spr_pizzagoblin_throwbomb
    global.throw_sprite[722] = spr_canongoblin_throwbomb
    global.throw_sprite[721] = spr_archergoblin_shoot
    global.throw_sprite[716] = spr_cheeserobot_attack
    global.throw_sprite[737] = spr_spitcheese_spit
    global.throw_sprite[374] = spr_tank_shoot
    global.throw_sprite[40] = spr_trash_throw
    global.throw_sprite[739] = spr_invtrash_throw
    global.throw_sprite[718] = spr_robot_attack
    global.throw_sprite[719] = spr_kentukykenny_throw
    global.throw_sprite[125] = spr_kentukykenny_throw
    global.throw_sprite[726] = spr_pizzard_shoot
    global.throw_sprite[731] = spr_pepgoblin_kick
    global.throw_sprite[1090] = spr_pepbat_kick
    global.throw_sprite[729] = spr_swedishmonkey_eat
    global.throw_sprite[728] = spr_ranch_shoot
    global.throw_sprite[727] = spr_pickle_attack
    global.throw_sprite[416] = spr_tank_shoot
    global.throw_sprite[708] = spr_shrimp_knife
    global.throw_sprite[709] = spr_shrimp_knife
    global.throw_sprite[684] = spr_shrimp_knife
    global.throw_sprite[420] = spr_pizzaslug_cough
    global.throw_sprite[748] = spr_ufolive_shoot
    global.throw_sprite[1128] = spr_kentukybomber_attack
    global.throw_sprite[528] = spr_ufogrounded_shoot
    global.throw_sprite[34] = spr_farmer2_throw
    global.throw_sprite[339] = spr_peasanto_throw
