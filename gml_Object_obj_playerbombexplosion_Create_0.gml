...
ds_map_set(collision_function, 683, function(argument0) //gml_Script_anon_gml_Object_obj_playerbombexplosion_Create_0_961_gml_Object_obj_playerbombexplosion_Create_0
{
    if instance_exists(obj_bossplayerdeath)
        return false;
...
ds_map_set(collision_function, 119, function(argument0) //gml_Script_anon_gml_Object_obj_playerbombexplosion_Create_0_4930_gml_Object_obj_playerbombexplosion_Create_0
{
    with (argument0)
    {
        if (fall && hp > 0)
...
ds_map_set(collision_function, 878, function(argument0) //gml_Script_anon_gml_Object_obj_playerbombexplosion_Create_0_5873_gml_Object_obj_playerbombexplosion_Create_0
{
    instance_destroy(argument0)
    return true;
}
)
ds_map_set(collision_function, 376, function(argument0) //gml_Script_anon_gml_Object_obj_playerbombexplosion_Create_0_5977_gml_Object_obj_playerbombexplosion_Create_0
{
    if scr_pistolhit(argument0, pistol_damage)
        return true;
    return false;
