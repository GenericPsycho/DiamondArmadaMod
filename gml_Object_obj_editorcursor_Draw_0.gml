if (obj_editor.editor_state == (1 << 0) && obj_editor.instance_state == (0 << 0) && ((!instance_exists(hovered_object)) || (hovered_object.object_index != obj_editorobject && object_get_parent(hovered_object.object_index) != 1140)))
{
