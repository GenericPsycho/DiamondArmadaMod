...
add_option_toggle(game_menu, 1, "option_vibration", function(argument0) //gml_Script_anon_gml_Object_obj_option_Create_0_6853_gml_Object_obj_option_Create_0
{
    ini_open_from_string(obj_savesystem.ini_str_options)
...
add_option_toggle(game_menu, 1, "option_screenshake", function(argument0) //gml_Script_anon_gml_Object_obj_option_Create_0_7172_gml_Object_obj_option_Create_0
{
    ini_open_from_string(obj_savesystem.ini_str_options)
...
var lang_option = add_option_multiple(game_menu, 2, "option_lang", lang, function(argument0) //gml_Script_anon_gml_Object_obj_option_Create_0_7803_gml_Object_obj_option_Create_0
{
    ini_open_from_string(obj_savesystem.ini_str_options)
...
lang_option.value = r
add_option_toggle(game_menu, 3, "option_timer", function(argument0) //gml_Script_anon_gml_Object_obj_option_Create_0_8261_gml_Object_obj_option_Create_0
{
    ini_open_from_string(obj_savesystem.ini_str_options)
...
add_option_multiple(game_menu, 4, "option_timer_type", [create_option_value("option_timer_level", 0), create_option_value("option_timer_save", 1), create_option_value("option_timer_levelsave", 2)], function(argument0) //gml_Script_anon_gml_Object_obj_option_Create_0_8694_gml_Object_obj_option_Create_0
{
    ini_open_from_string(obj_savesystem.ini_str_options)
...
add_option_toggle(game_menu, 5, "option_timer_speedrun", function(argument0) //gml_Script_anon_gml_Object_obj_option_Create_0_9014_gml_Object_obj_option_Create_0
{
    ini_open_from_string(obj_savesystem.ini_str_options)
...
add_option_press(controls_menu, 0, "option_back", function() //gml_Script_anon_gml_Object_obj_option_Create_0_9454_gml_Object_obj_option_Create_0
{
    menu_goto((0 << 0))
}
)
add_option_press(controls_menu, 1, "option_keyboard", function() //gml_Script_anon_gml_Object_obj_option_Create_0_9576_gml_Object_obj_option_Create_0
{
    menu_goto((9 << 0))
}
)
add_option_press(controls_menu, 2, "option_controller", function() //gml_Script_anon_gml_Object_obj_option_Create_0_9729_gml_Object_obj_option_Create_0
{
    menu_goto((8 << 0))
}
)
add_option_press(controls_menu, 3, "option_reset_config", function() //gml_Script_anon_gml_Object_obj_option_Create_0_9844_gml_Object_obj_option_Create_0
{
    ini_open_from_string(obj_savesystem.ini_str_options)
...
add_option_press(keyboard_menu, 0, "option_back", function() //gml_Script_anon_gml_Object_obj_option_Create_0_11797_gml_Object_obj_option_Create_0
{
    menu_goto((7 << 0))
}
)
add_option_press(keyboard_menu, 1, "option_controller_binds", function(argument0) //gml_Script_anon_gml_Object_obj_option_Create_0_11914_gml_Object_obj_option_Create_0
{
    obj_option.key_jump = false
    instance_create_unique(0, 0, obj_keyconfig)
}
)
add_option_toggle(keyboard_menu, 2, "option_keyboard_superjump", function(argument0) //gml_Script_anon_gml_Object_obj_option_Create_0_12080_gml_Object_obj_option_Create_0
{
    global.keyboard_superjump = argument0
    set_controller_config()
}
).value = global.keyboard_superjump
add_option_toggle(keyboard_menu, 3, "option_keyboard_groundpound", function(argument0) //gml_Script_anon_gml_Object_obj_option_Create_0_12267_gml_Object_obj_option_Create_0
{
...
add_option_press(controller_menu, 0, "option_back", function() //gml_Script_anon_gml_Object_obj_option_Create_0_12609_gml_Object_obj_option_Create_0
{
    menu_goto((7 << 0))
}
)
add_option_press(controller_menu, 1, "option_controller_binds", function(argument0) //gml_Script_anon_gml_Object_obj_option_Create_0_12728_gml_Object_obj_option_Create_0
{
    obj_option.key_jump = false
...
add_option_press(controller_menu, 2, "option_deadzone_title", function(argument0) //gml_Script_anon_gml_Object_obj_option_Create_0_12926_gml_Object_obj_option_Create_0
{
    menu_goto((10 << 0))
}
)
add_option_toggle(controller_menu, 3, "option_controller_superjump", function(argument0) //gml_Script_anon_gml_Object_obj_option_Create_0_13054_gml_Object_obj_option_Create_0
{
    global.gamepad_superjump = argument0
    set_controller_config()
}
).value = global.gamepad_superjump
add_option_toggle(controller_menu, 4, "option_controller_groundpound", function(argument0) //gml_Script_anon_gml_Object_obj_option_Create_0_13243_gml_Object_obj_option_Create_0
{
...
add_option_press(deadzones_menu, 0, "option_back", function() //gml_Script_anon_gml_Object_obj_option_Create_0_13603_gml_Object_obj_option_Create_0
{
    menu_goto((8 << 0))
}
)
add_option_slide(deadzones_menu, 1, "option_deadzone", function(argument0) //gml_Script_anon_gml_Object_obj_option_Create_0_13715_gml_Object_obj_option_Create_0
{
    if (argument0 > 90)
        argument0 = 90
...
add_option_slide(deadzones_menu, 2, "option_deadzone_h", function(argument0) //gml_Script_anon_gml_Object_obj_option_Create_0_13963_gml_Object_obj_option_Create_0
{
    if (argument0 > 90)
        argument0 = 90
...
add_option_slide(deadzones_menu, 3, "option_deadzone_v", function(argument0) //gml_Script_anon_gml_Object_obj_option_Create_0_14233_gml_Object_obj_option_Create_0
{
    if (argument0 > 90)
        argument0 = 90
...
add_option_slide(deadzones_menu, 4, "option_deadzone_press", function(argument0) //gml_Script_anon_gml_Object_obj_option_Create_0_14503_gml_Object_obj_option_Create_0
{
    if (argument0 > 90)
        argument0 = 90
...
add_option_slide(deadzones_menu, 5, "option_deadzone_superjump", function(argument0) //gml_Script_anon_gml_Object_obj_option_Create_0_14771_gml_Object_obj_option_Create_0
{
...
add_option_slide(deadzones_menu, 5, "option_deadzone_crouch", function(argument0) //gml_Script_anon_gml_Object_obj_option_Create_0_14997_gml_Object_obj_option_Create_0
{
