...
switch m.anchor
{
    ...
    case (1 << 0):
        ...
        for (i = 0; i < len; i++)
        {
            ...
            {
                case (0 << 0):
                    tdp_draw_text_color((obj_screensizer.actual_width - m.xpad), (yy + m.ypad * i), (o.value ? lang_get_value("option_on") : lang_get_value("option_off")), c, c, c, c, a)
                    break
                case (3 << 0):
                    var w = 200
                    var h = 5
                ...
                case (1 << 0):
                    ...
                    tdp_draw_text_color((obj_screensizer.actual_width - m.xpad), (yy + m.ypad * i), n, c, c, c, c, a)
                    break
            }
