if (global.levelcomplete && (!global.freezercutscene))
{
    ...
    currentroom = room
    dragonactor = 151543
    scene_info = [[gml_Script_cutscene_medieval_start], [gml_Script_cutscene_waitfor_sprite, 587], [function() //gml_Script_anon_gml_RoomCC_hub_freezerlobby_3_Create_344_gml_RoomCC_hub_freezerlobby_3_Create
    {
        with (obj_actor)
        {
