...
boss_array[6] = [532, 6]
state = (145 << 0)
attack_pool = [(174 << 0), (175 << 0), (176 << 0), states.jump, (177 << 0), (179 << 0), (180 << 0)]
...
function boss_destroy(argument0) //gml_Script_boss_destroy_gml_Object_obj_mrstickboss_Create_0
{
...
function boss_hurt(argument0, argument1) //gml_Script_boss_hurt_gml_Object_obj_mrstickboss_Create_0
{
    if (targetstunned > 0)
    {
...
function boss_hurt_noplayer(argument0) //gml_Script_boss_hurt_noplayer_gml_Object_obj_mrstickboss_Create_0
{
    if (targetstunned > 0)
    {
        targetstunned -= targetstunnedminus[(phase - 1)]
...
function player_hurt(argument0, argument1) //gml_Script_player_hurt_gml_Object_obj_mrstickboss_Create_0
{
