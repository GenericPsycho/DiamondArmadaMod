...
tdp_draw_text_color((obj_screensizer.actual_width / 2 - 250), 50, lang_get_value("option_back"), c, c, c, c, 1)
var ks = key_select
if (ks < 0)
    ks = 0
...
scr_draw_text_arr(32, (obj_screensizer.actual_height - 240), tip)
...
if selecting
{
    ...
    draw_set_alpha(1)
    tdp_draw_text_color((obj_screensizer.actual_width / 2), (obj_screensizer.actual_height / 2), lang_get_value("option_press_any"), 16777215, 16777215, 16777215, 16777215, 1)
}
tdp_text_commit(0, 0, obj_screensizer.actual_width, obj_screensizer.actual_height)
