...
setVibration = function(argument0, argument1, argument2, argument3) //gml_Script_anon_gml_Object_obj_inputAssigner_Create_0_827_gml_Object_obj_inputAssigner_Create_0
{
